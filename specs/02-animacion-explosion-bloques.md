...
- [x] Se pueden reproducir múltiples explosiones simultáneas sin que se interfieran
...
> Desviación registrada: la explosión se dibuja al tamaño de render del bloque (64×24),
> no a los 32×16 del modelo de datos. 32×16 es el tamaño del frame en el spritesheet;
> usarlo dejaría la animación más pequeña que el bloque que reemplaza.
